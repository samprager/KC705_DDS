...
set design k7_pcie_dma_ddr3_base_x8gen1
set top board 
set device xc7k325t-2-ffg900
set proj_dir vivado_sim_x8gen1
########################################
...
set_property verilog_define {{SIMULATION=1} {PCIEx8=1} {USE_DDR3_FIFO=1} {x1Gb=1} {sg125=1} {x8=1} {USE_7SERIES=1} {USE_PIPE_SIM=1}} [get_filesets sim_1]
...
import_ip -file {../../ip_catalog/pcie_7x_x8gen1.xci} -name pcie_7x
...
#update_compile_order -fileset sources_1
#set_property file_type {Verilog Header} [get_files  ../../sim/include/board_common.v]

update_compile_order -fileset sources_1
set_property file_type {Verilog Header} [get_files  ./vivado_sim_x8gen1/k7_pcie_dma_ddr3_base_x8gen1.srcs/sources_1/imports/include/board_common.v]
import_files -norecurse ../../sim/include/ddr3_model_parameters.vh
update_compile_order -fileset sources_1

generate_target all [get_files vivado_sim_x8gen1/k7_pcie_dma_ddr3_base_x8gen1.srcs/sources_1/ip/pcie_7x/pcie_7x.xci]
#add_files -fileset sim_1 -norecurse vivado_sim_x8gen1/k7_pcie_dma_ddr3_base_x8gen1.srcs/sources_1/ip/pcie_7x/pcie_7x/source/pcie_7x_gt_top_pipe_mode.v

## Generate MIG IP
generate_target all [get_files vivado_sim_x8gen1/k7_pcie_dma_ddr3_base_x8gen1.srcs/sources_1/ip/mig_7x/mig_7x.xci]
# Include search path 
set_property include_dirs { ../../tb ../../tb/dsport ../include ../../source/gen_chk ./vivado_sim_x8gen1/k7_pcie_dma_ddr3_base_x8gen1.srcs/sources_1/ip/mig_7x/mig_7x/example_design/sim} [get_filesets sim_1]
add_files -norecurse ../include/ddr3_model_parameters.vh
update_compile_order -fileset sources_1

# Add the DDR3 model files to the simset
add_files -fileset sim_1 -norecurse vivado_sim_x8gen1/k7_pcie_dma_ddr3_base_x8gen1.srcs/sources_1/ip/mig_7x/mig_7x/example_design/sim/ddr3_model.v
