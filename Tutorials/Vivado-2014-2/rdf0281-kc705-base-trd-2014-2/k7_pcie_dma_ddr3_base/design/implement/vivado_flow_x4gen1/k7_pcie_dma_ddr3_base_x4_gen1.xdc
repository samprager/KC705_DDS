...
#------------------------------------------------------------------------------------------
set_property LOC PLLE2_ADV_X1Y1 [get_cells virtual_pfifo_wrapper_inst/mp_pfifo_inst/mp_mc_inst/mig_inst/u_mig_7x_mig/u_ddr3_infrastructure/plle2_i]
...
#create_generated_clock -name clk_userclk -source [get_pins pcie_clk_ibuf/O] -edges {1 2 3} -edge_shift {0.000 -1.000 -2.000} [get_pins ext_clk.pipe_clock_i/mmcm_i/CLKOUT2]

#create_generated_clock -name clk_userclk2 -source [get_pins pcie_clk_ibuf/O] -edges {1 2 3} -edge_shift {0.000 -1.000 -2.000} [get_pins ext_clk.pipe_clock_i/mmcm_i/CLKOUT3]
