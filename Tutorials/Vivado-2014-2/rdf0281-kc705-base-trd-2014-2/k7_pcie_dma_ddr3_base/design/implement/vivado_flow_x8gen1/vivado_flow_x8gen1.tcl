...
set design k7_pcie_dma_ddr3_base_x8_gen1
set top k7_pcie_dma_ddr3_base
set device xc7k325t-2-ffg900
set proj_dir vivado_proj_1
#set synth_constraints ./k7_pcie_dma_ddr3_base_x8_gen1_synth.xdc
set impl_constraints ./k7_pcie_dma_ddr3_base_x8_gen1.xdc
########################################

# Project Settings
create_project -name ${design} -force -dir "./${proj_dir}" -part ${device}
set_property top ${top} [current_fileset]
set_property verilog_define { {RDS=1} {PCIEx8=1} {USE_KC705=1} {USE_DDR3_FIFO=1} {USE_7SERIES=1} } [current_fileset]
...
import_ip -files {../../ip_catalog/pcie_7x_x8gen1.xci} -name pcie_7x
