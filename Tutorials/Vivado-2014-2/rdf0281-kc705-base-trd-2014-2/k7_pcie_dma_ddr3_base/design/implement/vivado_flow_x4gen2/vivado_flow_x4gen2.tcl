...
set design k7_pcie_dma_ddr3_base_x4_gen2
set top k7_pcie_dma_ddr3_base
set device xc7k325t-2-ffg900
set proj_dir vivado_proj_1
#set synth_constraints ./k7_pcie_dma_ddr3_base_x4_gen2_synth.xdc
set impl_constraints ./k7_pcie_dma_ddr3_base_x4_gen2.xdc
########################################
...
#set_property is_enabled false [get_files ./vivado_proj_1/k7_pcie_dma_ddr3_base_x4_gen2.srcs/sources_1/ip/axis_async_fifo/axis_async_fifo/axis_async_fifo.xdc]
#set_property is_enabled false [get_files ./vivado_proj_1/k7_pcie_dma_ddr3_base_x4_gen2.srcs/sources_1/ip/axis_async_fifo/axis_async_fifo/axis_async_fifo_ooc.xdc]
